...
export interface StakeholderChangeDriverDepartment {
  id?: string;
...
export async function create(data: DataClient): Promise<Data> {
  const stakeholderChangeDrivers = () => data.postgres.withSchema(Database.schema).table('StakeholderChangeDriversDepartment');
